...
<div class="header_da">
    <header class="header clearfix">
        <div class="headerbox">
            ...
            <div class="navbar">
                <ul class="nav">
                    <li class="m on"><a href="<?php  echo webUrl('')?>" title="网站首页">网站首页<br>
                        <span>HOME</span></a></li>
                    ...
                    <li class="m"><a href="<?php  echo webUrl('company/intro')?>" title="关于我们">关于我们<br>
                        <span>ABOUT AS</span></a> </li>

                    <li class="m"><a href="<?php  echo webUrl('hompage/prosperity')?>" title="成功案例">成功案例<br>
                        <span>CASE</span></a> </li>

                    <li class="m"><a href="<?php  echo webUrl('hompage/problem')?>" title="常见问题">常见问题<br>
