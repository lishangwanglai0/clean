...
<div id="js-account-manage-modules-tpl" ng-controller="AccountMangeModulesTpl" ng-cloak>
	<div class="alert alert-info">
		<p><i class="fa fa-exclamation-circle"></i> 无主管理员时，创始人为默认主管理员，PC拥有所有权限</p>
	</div>
	<table c class="table we7-table table-hover" >
		...
		<tr ng-show="module_tpl.show">
			<td colspan="5">
				...
				<div class="col-sm-11">
					<div class="col-sm-3 text-left we7-margin-bottom" ng-repeat="module in module_tpl.webapp">
				...
				<div class="modal-body material-content clearfix">
					...
					<div class="material-body" ng-show="jurindex==0" id="content-modules">
						<div class="row">
							...
							<?php  if(empty($module['issystem']) && $module['webapp_support'] == 2) { ?>
							<div class="col-sm-2">
