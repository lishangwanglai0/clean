...
<div class="page-header">
    当前位置：<span class="text-primary"><?php  if($data['name']) { ?>编辑<?php  } else { ?>新增<?php  } ?>常见问题</small>
    </span>
</div>
...
<div class="page-content">
    ...
    <div class="page-sub-toolbar">
        <a class="btn btn-primary btn-sm" href="<?php  echo webUrl('faq/add')?>"><?php  if($data['name']) { ?>编辑<?php  } else { ?>新增<?php  } ?>常见问题</a>
    </div>
    <?php  } ?>

    <form action="<?php  if(empty($data)) { ?><?php  echo webUrl('faq/add')?><?php  } else { ?><?php  echo webUrl('faq/edit')?><?php  } ?>" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
