...
<div class="page-header">
    当前位置：<span class="text-primary">公司介绍</span>
</div>
    ...
    <form action="./index.php" method="get" class="form-horizontal form-search" role="form">
        ...
        <div class="page-toolbar">
            <span class="pull-left" style="margin-right:30px;">
                <a class='btn btn-sm btn-primary' href="<?php  echo webUrl('corporation/add')?>"><i class='fa fa-plus'></i> 新增公司介绍</a>
            ...
            <table class="table table-responsive">
                ...
                <tr>
                    ...
                    <td  style="overflow:visible;position:relative">
                        ...
                        <a  class='btn  btn-op btn-operation' href="<?php  echo webUrl('corporation/edit', array('id' => $item['id']))?>">
                        ...
                        <a  class='btn  btn-op btn-operation' data-toggle='ajaxRemove' href="<?php  echo webUrl('corporation/delete', array('id' => $item['id']))?>" data-confirm='如果此商品存在购买记录，会无法关联到商品, 确认要彻底删除吗?？'>
